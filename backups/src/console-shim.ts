 ...
 * Enables structured logging via Winston while maintaining the familiar console interface.
 */
 ...
 * (console as any).__original should exist if overrideGlobalConsole was called
 */

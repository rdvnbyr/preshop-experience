...
class ShopwareApiService {
  ...
  // Product API
  async getProducts(params: ShopwareProductListParams = {}): Promise<ShopwareListResponse<ShopwareProduct>> {
    return this.makeRequest<ShopwareListResponse<ShopwareProduct>>('store-api/product', {
      method: 'POST',
      body: JSON.stringify(params),
    });
  }

  async getProduct(productId: string, options: {
    ...
    const response = await this.makeRequest<ShopwareProductDetailResponse>(endpoint, {
      method: 'POST',
  ...
  async searchProducts(term: string, params: Omit<ShopwareProductListParams, 'search'> = {}): Promise<ShopwareListResponse<ShopwareProduct>> {
  ...
  // Category API
  async getCategories(params: ShopwareCategoryListParams = {}): Promise<ShopwareListResponse<ShopwareCategory>> {
    const searchParams = new URLSearchParams();
    
    if (params.page) searchParams.append('page', params.page.toString());
    if (params.limit) searchParams.append('limit', params.limit.toString());
    if (params.sort) searchParams.append('sort', params.sort);
    if (params['total-count-mode']) searchParams.append('total-count-mode', params['total-count-mode'].toString());
  ...
  async getCategory(categoryId: string, associations?: Record<string, any>): Promise<ShopwareApiResponse<ShopwareCategory>> {
    const searchParams = new URLSearchParams();
  ...
  async getCategoryProducts(
    ...
    if (params['manufacturer[]']) {
      params['manufacturer[]'].forEach(m => searchParams.append('manufacturer[]', m));
    }
    
    if (params['min-price'] !== undefined) searchParams.append('min-price', params['min-price'].toString());
    if (params['max-price'] !== undefined) searchParams.append('max-price', params['max-price'].toString());
    
    if (params.rating) searchParams.append('rating', params.rating.toString());
    if (params['shipping-free']) searchParams.append('shipping-free', '1');
    
    if (params['properties[]']) {
      params['properties[]'].forEach(p => searchParams.append('properties[]', p));
    }

    // const queryString = searchParams.toString();
    const endpoint = `store-api/product-listing/${categoryId}`;
    
    return this.makeRequest<ShopwareProductListingResponse>(endpoint, { method: 'POST' });
  }

  async getNavigationCategories(depth = 2): Promise<ShopwareListResponse<ShopwareCategory>> {
  ...
  async getCart(): Promise<ShopwareApiResponse<ShopwareCart>> {
    return this.makeRequest<ShopwareApiResponse<ShopwareCart>>('store-api/checkout/cart');
  }

  async addToCart(items: ShopwareCartLineItemRequest[]): Promise<ShopwareApiResponse<ShopwareCart>> {
    return this.makeRequest<ShopwareApiResponse<ShopwareCart>>('store-api/checkout/cart/line-item', {
      method: 'POST',
      body: JSON.stringify({ items }),
    });
  }

  async updateCartItem(lineItemId: string, quantity: number): Promise<ShopwareApiResponse<ShopwareCart>> {
    return this.makeRequest<ShopwareApiResponse<ShopwareCart>>('store-api/checkout/cart/line-item', {
      method: 'PATCH',
      body: JSON.stringify({
        items: [
  ...
  async removeFromCart(lineItemIds: string[]): Promise<ShopwareApiResponse<ShopwareCart>> {
    return this.makeRequest<ShopwareApiResponse<ShopwareCart>>('store-api/checkout/cart/line-item', {
      method: 'DELETE',
  ...
  // Customer API
  async registerCustomer(data: ShopwareCustomerRegistrationRequest): Promise<ShopwareApiResponse<ShopwareCustomer>> {
    return this.makeRequest<ShopwareApiResponse<ShopwareCustomer>>('store-api/account/register', {
      method: 'POST',
      body: JSON.stringify(data),
    });
  }

  async loginCustomer(data: ShopwareCustomerLoginRequest): Promise<ShopwareApiResponse<ShopwareCustomer>> {
    return this.makeRequest<ShopwareApiResponse<ShopwareCustomer>>('store-api/account/login', {
      method: 'POST',
      body: JSON.stringify(data),
    });
  }
  ...
  async getCustomerProfile(): Promise<ShopwareApiResponse<ShopwareCustomer>> {
    return this.makeRequest<ShopwareApiResponse<ShopwareCustomer>>('store-api/account/customer');
  }

  async updateCustomerProfile(data: Partial<ShopwareCustomer>): Promise<ShopwareApiResponse<ShopwareCustomer>> {
    return this.makeRequest<ShopwareApiResponse<ShopwareCustomer>>('store-api/account/customer', {
      method: 'PATCH',
      body: JSON.stringify(data),
    });
  ...
  // Order API
  async createOrder(data: ShopwareOrderRequest = {}): Promise<ShopwareApiResponse<ShopwareOrder>> {
    return this.makeRequest<ShopwareApiResponse<ShopwareOrder>>('store-api/checkout/order', {
      method: 'POST',
      body: JSON.stringify(data),
    });
  }

  async getOrders(page = 1, limit = 10): Promise<ShopwareListResponse<ShopwareOrder>> {
    const searchParams = new URLSearchParams({
      page: page.toString(),
    ...
    return this.makeRequest<ShopwareListResponse<ShopwareOrder>>(`store-api/order?${searchParams.toString()}`);
  }

  async getOrder(orderId: string): Promise<ShopwareApiResponse<ShopwareOrder>> {
    return this.makeRequest<ShopwareApiResponse<ShopwareOrder>>(`store-api/order/${orderId}`);
  }
